...
/* The bookable experiences moved to data/experiences.ts — the Experience
   Collection is now the single taxonomy for the site, /book, and /reviews.
   Its `slug` doubles as the portal `experience_key`. */
